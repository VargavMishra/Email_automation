      ...
      <section className="app-container w-full space-y-6">
        ...
        <nav className="flex justify-between items-center mb-8 relative z-50">
          ...
          <div className="flex gap-3 items-center">
            {/* Dark Mode Toggle */}
            <button onClick={toggleDarkMode} className="relative w-10 h-10 rounded-full border border-gray-200 bg-white/50 hover:bg-white hover:shadow-sm flex justify-center items-center transition-all" aria-label="Toggle Dark Mode">
              {isDarkMode ? (
        ...
        {error ? (
          <div className="glass-panel motion-enter rounded-2xl px-5 py-4 text-sm text-red-600 dark:text-red-400">
        ...
        {notice ? (
          <div className="glass-panel motion-enter rounded-2xl px-5 py-4 text-sm text-emerald-700 dark:text-emerald-400">
